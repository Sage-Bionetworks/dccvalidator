...
1. Contact the Data Liaison (AMPAD_SageAdmin@synapse.org) to discuss the study and the expected data. Receive
...
5. Contact the AD Data Liaison when all files pass validation. The team will verify
...
7. Contact the AD Data Liaison. The AD Curation team will do the final verifications before
releasing the data.
