...
1. Contact the Data Liaison (juliane.schneider@sagebase.org) to discuss the study and the expected data. Receive
...
3. Upload the study description, methods description and acknowledgement statement using the [Submission Form](https://www.synapse.org/#!Synapse:syn25051271)
