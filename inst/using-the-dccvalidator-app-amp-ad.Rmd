...
The [dccvalidator tool](https://shinypro.synapse.org/users/kwoo/dccvalidator-app/) checks your metadata for, among other things:
...
1. Contact the [AD Data Liaison](mailto:AMPAD_SageAdmin@synapse.org) to discuss the study and the expected data. Receive
staging folder synIDs for each expected dataset.
2. Using the templates located at the bottom of the [Onboarding page](https://www.synapse.org/#!Synapse:syn24986618), create a study description, methods description(s), and acknowledgement statement.
3. Upload the [study description](https://www.synapse.org/#!Synapse:syn25014531), [methods description](https://www.synapse.org/#!Synapse:syn25018065) and [acknowledgement statement](https://www.synapse.org/#!Synapse:syn25014532) using the [Submission Form](https://www.synapse.org/#!Synapse:syn25051271). Instructions on writing this documentation is located on our [Data Contributor Information](https://www.synapse.org/#!Synapse:syn24986618) page.
4. Validate metadata + manifest files in [dccvalidator](https://shinypro.synapse.org/users/kwoo/dccvalidator-app/).
5. Contact the [AD Data Liaison](mailto:AMPAD_SageAdmin@synapse.org) when all files pass validation. The team will verify
...
[Synapse documentation](https://docs.synapse.org/articles/uploading_in_bulk.html#validate-the-manifest-and-upload-files) for uploading data in bulk).
7. Contact the [AD Data Liaison](mailto:AMPAD_SageAdmin@synapse.org). The AD Curation team will do the final verifications before
releasing the data.
...
You can submit your documentation through the [Submission Form](https://www.synapse.org/#!Synapse:syn25051271) located on our [Onboarding Documentation](https://www.synapse.org/#!Synapse:syn24986618)
