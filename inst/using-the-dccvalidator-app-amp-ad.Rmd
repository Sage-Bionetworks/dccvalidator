...
* The values in the cells are correct if the column uses controlled values (TRUE is used instead of Yes or Y)
...
5. Contact the AMP-AD team when all files pass validation. The team will verify
...
7. Contact the AMP-AD team. The team will do the final verifications before
releasing the data.
