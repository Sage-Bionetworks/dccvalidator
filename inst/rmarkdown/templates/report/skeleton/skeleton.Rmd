...
```{r individual-missing-cols, eval = indiv_cols != character(0)}
...
```{r missing_from_assay, eval = missing_from_assay}
report(
...
```{r missing_from_individual, eval = missing_from_individual}
report(
...
```{r indviduals-all-good, eval = !any(c(missing_from_assay, missing_from_individual))}
