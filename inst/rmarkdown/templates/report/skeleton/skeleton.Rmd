...
indiv_comparison <- check_indiv_ids_match(params$individual, params$biospecimen)
...
specimen_comparison <- check_specimen_ids_match(params$biospecimen, params$assay)
