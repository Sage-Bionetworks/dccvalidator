...
1. A metadata template is used
2.All required columns from the templates are present
3. Individuals and specimens have unique identifiers, and the identifiers match across different metadata files
4. Metadata terms conform to a controlled vocabulary, where applicable
5. Duplicates file path in the manifest
