...
vignette: >
  %\VignetteIndexEntry{using-the-dccvalidator-app}
...
```
insert screenshot of validation results here
```
...
```
insert screenshot of data summary here
```
...
```
insert screenshot of documentation upload here
```
