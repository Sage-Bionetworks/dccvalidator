...
* `path_to_markdown`: The `system.file()` path to the markdown document with app 
  instructions. This option must follow the format 
  `!expr system.file("path_to_md_document.Rmd", package = "dccvalidator")`. 
  If you wish to omit app embedded instructions, insert `!expr NA`.
